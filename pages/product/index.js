                    ...
                    <tr key={index}>
                        ...
                        <td>
                            <Select2
                                ...
                                const newData = props.field.value;
                                const locObj = props.locList[index].find(element => element.loc_code == locCode);
        ...
        return (
            <Formik
                ...
                onSubmit={async (values) => {
                    const res = await axios({
                        method: 'post',
                        url: 'http://localhost:8082/ndvn-wms-war/api/addItem.json',
                        headers: {
                            'Authorization': 'Bearer ' + this.props.token,
            ...
            {formik => (    
                <Form>
                        ...
                        <table className="form-table table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><Field name="productNo" type="text" className="form-control" maxLength="50" tabIndex="0" /> <ErrorMessage name="productNo" /></td>

                                    { /* ITEM_NAME */}
                                    <td className="control-label">ITEM_NAME <span className="required">&nbsp;*</span></td>
                                    <td><Field name="productName" type="text" className="form-control" maxLength="50" tabIndex="0" /><ErrorMessage name="productName" /></td>
                                </tr>
                                <tr>
                                    { /* PRODUCT_LOCAL_NAME */}
                                    ...
                                    { /*  ITEM_NUMBER */}
                                    <td className="control-label"> ITEM_NUMBER</td>
                                    <td>
                    ...
                    { /* Card footer */}
                    <CardFooter>
                        <button type="submit" className="button btn btn-primary" disabled={formik.isSubmitting}>
                            Save
                        </button>
                    </CardFooter>
                    { /* End card footer */}
...
export default withAuthSync(CreateCondition)